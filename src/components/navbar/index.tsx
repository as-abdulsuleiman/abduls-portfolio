  ...
  return (
    <Menu as="div" className="block fixed top-[32px] md:top-[63px]">
      <Menu.Button
        ...
        className="rounded-full z-[100] ring-[1px] cursor-pointer ring-[#717070] p-1.5 bg-primary-black bg-gradient-to-tl from-primary-black via-zinc-400/10 to-zinc-900 transition-opacity opacity-70 hover:opacity-100"
      >
      ...
      >
        <Menu.Items className="absolute mt-2 w-48 right-0 z-[999] rounded-md shadow-lg ring-[1px] ring-[#717070] ring-opacity-5 focus:outline-none bg-primary-black bg-gradient-to-tl from-primary-black via-zinc-400/10 to-zinc-900 text-[#D8D3CB] drop-shadow-md border-[#717070] border-[0.5px]">
